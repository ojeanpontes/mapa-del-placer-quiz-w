...
const imageLibrary = {
  ...
  tension: {
    src: "./assets/black-couple-distance-bedroom.jpg",
    alt: "Pareja distante en una habitación con él mirando el celular",
    credit: "Imagen: producción propia",
    position: "center 39%",
  },
  reflection: {
    src: "./assets/black-woman-phone-bedroom.jpg",
    alt: "Mujer pensativa sentada en la cama mirando el celular",
    credit: "Imagen: producción propia",
    position: "center 32%",
  },
  promise: {
    src: "./assets/black-magnetic-woman.jpg",
    alt: "Mujer elegante con vestido vino en un corredor premium",
    credit: "Imagen: producción propia",
    position: "center 34%",
  },
  studyDesk: {
    src: "./assets/black-investigation-board.jpg",
    alt: "Panel de investigación con notas, fotos y líneas rojas",
    credit: "Imagen: producción propia",
    position: "center 42%",
  },
  studyPaper: {
    src: "./assets/black-confidential-writing.jpg",
    alt: "Mano escribiendo una nota confidencial con pluma dorada",
    credit: "Imagen: producción propia",
    position: "center 45%",
  },
  malumaSolo: {
    src: "./assets/black-maluma-inspired-solo.jpg",
    alt: "Retrato editorial de hombre famoso en evento premium",
    credit: "Recreación editorial",
    position: "center 24%",
  },
  susanaGomez: {
    src: "./assets/black-susana-inspired-solo.jpg",
    alt: "Retrato editorial de mujer elegante y reservada",
    credit: "Recreación editorial",
    position: "center 30%",
  },
  malumaSusanaProcura: {
    src: "./assets/black-story-procura-announcement.jpg",
    alt: "Recreación editorial de revelación pública en backstage de videoclip",
    credit: "Recreación editorial",
    position: "center center",
  },
  malumaSusanaRedCarpet: {
    src: "./assets/black-story-red-carpet.jpg",
    alt: "Recreación editorial de pareja elegante en alfombra roja",
    credit: "Recreación editorial",
    position: "center 34%",
  },
  malumaSusanaSecondBaby: {
    src: "./assets/black-story-family-announcement.jpg",
    alt: "Recreación editorial de familia latina y embarazo",
    credit: "Recreación editorial",
    position: "center 42%",
  },
};
...
const steps = [
  ...
  },
  {
    ...
    microcopy:
      "La historia se apoya en hechos públicos. Las imágenes son recreaciones editoriales para explicar el patrón sin romper la experiencia.",
